...
{"name":"MakeScreenCapture","status":false,"description":"画面キャプチャ管理プラグイン","parameters":{"PNGキャプチャキー":"F6","JPEGキャプチャキー":"F7","WEBPキャプチャキー":"F10","ファイル名":"image","出力場所":"/captures","保存形式":"png","連番桁数":"2","タイムスタンプ":"ON","署名":"","署名サイズ":"22","署名画像":"","実行間隔":"0","効果音":"Flash1"}},
{"name":"MessageWindowHidden","status":false,"description":"メッセージウィンドウ一時消去プラグイン","parameters":{"ボタン名称":"control"}},
...
{"name":"DebugMonitor","status":false,"description":"スイッチ・変数の状態を画面上にリアルタイム表示します。","parameters":{"monitorX":"0","monitorY":"100","monitorW":"240"}},
...
{"name":"TimeEvent","status":false,"description":"時間の経過に応じてイベントを起こします。","parameters":{}},
